    ...
    <section className="px-4 py-20 max-w-5xl mx-auto">
      ...
      <div className="flex justify-center gap-4">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 cursor-pointer rounded-full border border-on-surface/30 text-on-surface hover:bg-primary hover:border-primary transition-colors"
        >
          <SiGithub size={20} />
